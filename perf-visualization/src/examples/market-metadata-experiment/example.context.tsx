...
export const ExampleContext = createContext<ExampleControlsValues>(
  ExampleContextDefaults,
);
...
export const ExampleContextProvider = ({
  ...
  const [historicalDays, setHistoricalDays] = useState(
    ExampleContextDefaults.historicalDays,
  );

  const [changingProps, updateChangingProps] = useState(
    ExampleContextDefaults.changingProps,
  );
